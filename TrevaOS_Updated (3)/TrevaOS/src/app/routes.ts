...
import { SuperAdminOutlets } from "./pages/admin/SuperAdminOutlets";
...
export const router = createBrowserRouter([
  ...
  // ── Super Admin routes (separate layout, admin-only) ───────────────────────
  {
    path: "/admin",
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "outlets",          Component: SuperAdminOutlets       },
          { path: "tickets",          Component: SuperAdminTickets       },
          { path: "subscriptions",    Component: SuperAdminSubscriptions },
  ...
  // ── Outlet Owner routes (existing Layout with restaurant sidebar) ──────────
  {
    path: "/",
