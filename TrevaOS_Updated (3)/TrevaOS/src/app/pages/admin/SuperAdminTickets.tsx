...
import { DEMO_TICKETS, PRIORITY_COLORS, TICKET_STATUS_COLORS } from "./adminData";
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      <Badge variant="outline" className={`text-xs capitalize ${TICKET_STATUS_COLORS[ticket.status]}`}>{ticket.status.replace("-", " ")}</Badge>
                    </div>
